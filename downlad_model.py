...
if __name__ == '__main__':
    ...
    parser.add_argument('MODEL', type=str, default="TheBloke/Llama-2-13B-chat-GPTQ", nargs='?')
    parser.add_argument('--branch', type=str, default='gptq-4bit-32g-actorder_True', help='Name of the Git branch to download from.')
